...
use Vankosoft\VendoSdkBundle\Payum\Request\Api\CreditCardSignup;

class CreditCardSignupAction
{
    ...
    public function execute( $request )
    {
        ...
        try {
            $response = $this->api->doCreditCardSignup(
    ...
    {
        return
            $request instanceof CreditCardSignup &&
